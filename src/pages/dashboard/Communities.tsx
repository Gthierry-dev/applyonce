      ...
      <div className="py-16 px-4 md:px-8 lg:px-16">
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto text-center mb-10">
            <h1 className="text-4xl font-bold mb-4">Join Our Communities</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              },
              {
                ...
                content: "Post questions and get help from Communities members and experts in various fields.",
          ...
          <div className="max-w-6xl mx-auto mt-16">
            <Card>
              <CardHeader>
                <CardTitle>Communities Discussions</CardTitle>
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-background/80">
                      <div className="text-center">
                        ...
                        <p className="text-sm text-muted-foreground mb-4">
                          Login to access Communities discussions and connect with other members
                        </p>
