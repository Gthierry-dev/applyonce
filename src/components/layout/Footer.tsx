        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 text-sm text-foreground/70 max-w-xs">
              Streamline application processes and focus on what matters most.
            </p>
          ...
          <div className="grid grid-cols-2 gap-8 lg:col-span-3 md:grid-cols-3">
            <div>
              ...
              <ul className="mt-4 space-y-2">
                ...
                <li><a href="#" className="text-sm text-foreground/70 hover:text-foreground transition-colors">FAQ</a></li>
                <li><a href="#" className="text-sm text-foreground/70 hover:text-foreground transition-colors">Testimonials</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="mt-4 space-y-2">
                ...
                <li><a href="#" className="text-sm text-foreground/70 hover:text-foreground transition-colors">Jobs</a></li>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                <li><a href="#" className="text-sm text-foreground/70 hover:text-foreground transition-colors">Privacy</a></li>
                <li><a href="#" className="text-sm text-foreground/70 hover:text-foreground transition-colors">Terms</a></li>
                <li><a href="#" className="text-sm text-foreground/70 hover:text-foreground transition-colors">Cookie Policy</a></li>
                <li><a href="#" className="text-sm text-foreground/70 hover:text-foreground transition-colors">Contact</a></li>
              </ul>
            </div>
          </div>
        </div>
        <div className="mt-12 border-t border-border/20 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-base text-foreground/60">
            &copy; {new Date().getFullYear()} ApplyOnce, Inc. All rights reserved.
          </p>
