...
import { Search, MapPin, Clock, DollarSign, Bookmark, Filter, SortAsc } from 'lucide-react';
    ...
    <div className="min-h-screen ">
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold mb-4">
              Explore Opportunities Across Careers,<br />Scholarships, Hackathons & More
            </h1>
            ...
            <div className="bg-white rounded-xl p-2 flex gap-2">
              ...
              <div className="flex-1">
                <Input
                  ...
                  className="border-0 focus:ring-green-500"
                />
              </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        <div className="flex flex-wrap items-center gap-2 mb-6">
          {['For You', 'Trending', 'New', 'Nearby', 'Urgent', 'Scholarships', 'Hackathons', 'Jobs', 'Internships', 'Remote'].map((tab) => (
            <Button
              key={tab}
              variant={tab === 'For You' ? 'default' : 'outline'}
              size="sm"
              className={tab === 'For You' ? 'bg-teal-600 hover:bg-teal-700' : 'hover:bg-teal-50 hover:text-teal-700'}
            >
              {tab}
            </Button>
          ))}
